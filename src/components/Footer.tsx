          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button className="btn-secondary whitespace-nowrap inline-flex items-center space-x-2">
                  <span>Subscribe</span>
                ...
                <div className="flex space-x-3">
                  {[
                    ...
                    <a
                      ...
                      className="w-10 h-10 bg-gray-700 rounded-lg flex items-center justify-center hover:bg-travel-orange transition-all duration-200 transform hover:scale-110"
                    >
