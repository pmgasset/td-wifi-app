    ...
    <Layout title="CSS Test - Travel Data WiFi">
      <div className="p-8">
        <div className="test-css-loading mb-8">
          If you can see this red box, CSS is loading!
        </div>
        
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-travel-blue mb-4">CSS Test Page</h1>
          <p className="text-lg text-gray-600 mb-6">This page tests if our CSS is working correctly.</p>
        </div>
        ...
        <div className="bg-travel-orange text-white p-6 rounded-lg">
